...
public class BackgroundGraphicsComponent implements GraphicsComponent {
    ...
    public void draw(Canvas canvas,
        ...
        drawWithPositionPlayer(canvas, paint,cam,t);
    ...
    private void drawWithPositionPlayer(Canvas canvas, Paint paint, Camera cam,Transform t) {
        ...
        float a = cam.getCameraWorldCentreY();
        float b = cam.getyCentre();
