...
public class SoundEngine {
    ...
    private static  int mPlayer_Main_ID = -1;
    ...
    public SoundEngine(Context c){
        ...
        try {
            ...
            descriptor = assetManager.openFd("main3.mp3");
            mPlayer_Main_ID = mSP.load(descriptor, 0);
    ...
    public static void playPlayerMain(){
        mSP.play(mPlayer_Main_ID,1, 1, 0, 0, 1);
    }
}
